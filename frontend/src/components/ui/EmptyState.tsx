 ...
 * @param {EmptyStateSize} size - Size variant: 'sm' | 'md' | 'lg' (default: 'md')
 */
...
// No workflows
export function EmptyWorkflows({ onCreate }: EmptyWorkflowsProps) {
  return (
    <EmptyState
      icon="⚙️"
...
// Error state
export function EmptyError({ message = 'Something went wrong', onRetry }: EmptyErrorProps) {
  return (
    <EmptyState
      icon="⚠️"
