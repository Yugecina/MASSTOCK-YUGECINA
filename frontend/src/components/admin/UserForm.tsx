...
import type { UserFormProps, CreateUserFormData, EditUserFormData } from '../../types/admin';
 ...
 */
export function UserForm({ mode = 'create', user = null, onSubmit, onCancel }: UserFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
      ...
      <div className="input-group">
        ...
        />
        {errors.company_name && (
          <span className="text-error text-sm">{errors.company_name.message as string}</span>
        )}
      </div>
      ...
      <div className="input-group">
        ...
        {errors.plan && (
          <span className="text-error text-sm">{errors.plan.message as string}</span>
        )}
      </div>
      ...
      <div className="input-group">
        ...
        {errors.subscription_amount && (
          <span className="text-error text-sm">{errors.subscription_amount.message as string}</span>
        )}
      </div>
      ...
      {mode === 'edit' && (
        <div className="input-group">
          ...
          {errors.status && (
            <span className="text-error text-sm">{errors.status.message as string}</span>
          )}
        </div>
      )}
