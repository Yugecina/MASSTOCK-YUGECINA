...
import type { AddMemberModalProps, UserSearchResult } from '../../types/admin';

/**
 * AddMemberModal - Search and add users to client
 */
export function AddMemberModal({ clientId, onClose }: AddMemberModalProps) {
  const [searchQuery, setSearchQuery] = useState<string>('');
  const [selectedUser, setSelectedUser] = useState<UserSearchResult | null>(null);
  const [selectedRole, setSelectedRole] = useState<'owner' | 'collaborator'>('collaborator');
          ...
          <div className="admin-modal-body">
            ...
            <div className="admin-form-group">
              ...
              <select
                ...
                value={selectedRole}
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setSelectedRole(e.target.value as 'owner' | 'collaborator')}
              >
