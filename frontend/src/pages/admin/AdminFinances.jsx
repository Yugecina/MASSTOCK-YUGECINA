...
/**
 * AdminFinances - Editorial Financial Dashboard
 * Refined luxury with data-driven precision
 */
      ...
      <div className="finances-page">
        ...
        <header className="finances-hero">
          ...
          <div className="finances-hero-actions">
            ...
            <button className="export-btn" onClick={() => toast.info('Export feature coming soon')}>
