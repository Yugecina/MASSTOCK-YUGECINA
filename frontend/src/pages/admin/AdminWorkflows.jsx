...
/**
 * AdminWorkflows - Data Luxury Design
 * Premium workflow management with sophisticated card layouts
 */
            ...
            <div className="admin-workflows-stats-bar">
              ...
              <div className="admin-workflows-stat-pill">
                <span className="admin-workflows-stat-pill-value">
                  {workflows.reduce((sum, w) => sum + (w.stats?.total_executions || 0), 0).toLocaleString()}
                </span>
                <span className="admin-workflows-stat-pill-label">Total Executions</span>
              </div>
              <div className="admin-workflows-stat-pill">
                <span className="admin-workflows-stat-pill-value">
                  {formatRevenue(workflows.reduce((sum, w) => sum + parseFloat(w.stats?.revenue || 0), 0))}
                </span>
