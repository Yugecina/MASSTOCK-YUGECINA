/**
 * AdminAnalytics Page - TypeScript
 * Analytics dashboard with KPIs, charts, and tables
...
type ActiveTab = 'executions' | 'success' | 'revenue';
...
export default function AdminAnalytics() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const [overviewData, trendDataResult, performanceData, failuresData] = await Promise.all([
    ...
    <div className="container py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <AnalyticsCard
          ...
          trend={overview?.executionsTrend ? (overview.executionsTrend > 0 ? 'up' : overview.executionsTrend < 0 ? 'down' : 'neutral') : undefined}
        ...
        <AnalyticsCard
          ...
          trend={overview?.successTrend ? (overview.successTrend > 0 ? 'up' : overview.successTrend < 0 ? 'down' : 'neutral') : undefined}
