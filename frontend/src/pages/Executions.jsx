...
export function Executions() {
  ...
  const sortedExecutions = useMemo(() => {
    ...
    const clonedExecutions = executions.map(ex => ({ ...ex }))
  ...
  const renderExecutionCard = useCallback((execution) => {
    const statusConfig = {
          ...
          <div className="executions-list-container">
            <div className={`executions-list-wrapper ${executionsRefreshing ? 'is-refreshing' : ''} ${justUpdated ? 'just-updated' : ''}`}>
              <div className="executions-list">
                {sortedExecutions.map(execution => renderExecutionCard(execution))}
              </div>
            </div>
