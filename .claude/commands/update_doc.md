...
- Then update the README.md, make sure you include an index of all documentation created in .agent, so anvone can just look at README.md to aet full understanding of where to look for what information
